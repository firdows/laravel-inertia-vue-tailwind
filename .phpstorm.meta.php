...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'debugbar.options.db.exclude_paths' => 'string',
            ...
            'filesystems.links.D:\xampp7.4\htdocs\laravel-inertia-vue-tailwind\public\storage' => 'string',
...
'filesystems.links.D:\\xampp7.4\\htdocs\\laravel-inertia-vue-tailwind\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'debugbar.queries.explain','home','login',
'login.store','user-account.create','user-account.store','listing.index','listing.show',
'realtor.listing.restore','realtor.listing.index','realtor.listing.create','realtor.listing.store','realtor.listing.show',
'realtor.listing.edit','realtor.listing.update','realtor.listing.destroy','realtor.listing.image.create','realtor.listing.image.store',
'realtor.listing.image.destroy','listing.offer.store','logout','storage.local',);
        registerArgumentsSet('views', 
'app','welcome','breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma',
'breadcrumbs::foundation6','breadcrumbs::materialize','breadcrumbs::tailwind','breadcrumbs::uikit','laravel-exceptions-renderer::components.card',
